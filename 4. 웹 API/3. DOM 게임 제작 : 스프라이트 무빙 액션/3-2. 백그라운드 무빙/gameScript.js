...
const moveTo = {
    ...
    ArrowUp: (function backward() { return function(){ characterLocation.y -= step; } })(),
    ArrowLeft: (function forward() { return function(){ characterLocation.x -= step; } })(),
...
document.addEventListener('keydown', (event) => {
    ...
    // 4-5. 타운맵 이동
    $townMap.setAttribute('style', `background-position: ${-characterLocation.x}px ${-characterLocation.y}px`);
